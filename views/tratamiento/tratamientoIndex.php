...
<head>
    ...
    <?php
        ...
        if (file_exists($cssPath)) {
            ...
            echo ' NO SE PUDO ENCONTRAR EL ARCHIVO CSS EN: ' . $cssPath . '';
        }
    ?>
    <!-- FONT AWESOME -->
...
<body>
    ...
    <a href="/proyecto_sab/controllers/TratamientoController.php?accion=view_store">Registrar Nuevo Tratamiento <i class="fa-solid fa-square-plus"></i></a>
    <table id="TratamientosDatatable" class="display">
        <thead>
            <tr>
                <th>Codigo</th>
                <th>Nombre</th>
        ...
        <tbody>
            <?php foreach ($tratamientos as $tratamiento): ?>
                <tr>
                    ...
                    <td>
                        <a href="/proyecto_sab/controllers/TratamientoController.php?accion=view_update&id_tratamiento=<?= $tratamiento['id_tratamiento'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="/proyecto_sab/controllers/TratamientoController.php?accion=delete&id_tratamiento=<?= $tratamiento['id_tratamiento'] ?>"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#TratamientosDatatable').DataTable({
                    dom: "Blfrtip",
