...
<body>
    ...
    <a href="/proyecto_sab/controllers/HistorialController.php?accion=view_store">Generar Historial Clinico<i class="fa-solid fa-square-plus"></i></a>
    <table id="HistorialDatatable" class="display">
        <thead>
            <tr>
                <th>Id</th>
                <th>Paciente</th>
        ...
        <tbody>
            <?php foreach ($historias as $historia): ?>
                <tr>
                    ...
                    <td>
                        <a href="/proyecto_sab/controllers/HistorialController.php?accion=view_update&id_historial=<?= $historia['id_historial'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="/proyecto_sab/controllers/HistorialController.php?accion=delete&id_historial=<?= $historia['id_historial'] ?>"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
