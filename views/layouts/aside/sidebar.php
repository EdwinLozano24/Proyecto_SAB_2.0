                ...
                <ul class="sidebar__menu">
                        ...
                        <a href="index.php?c=Citas&a=home" class="sidebar__link">
                            <div class="sidebar__icon">
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19,4H5C3.89,4 3,4.89 3,6V20A2,2 0 0,0 5,22H19A2,2 0 0,0 21,20V6C21,4.89 20.1,4 19,4M19,20H5V6H19V20M17,8H7V10H17V8M13,14H7V12H13V14M7,16H15V18H7V16Z" />
                                </svg>
                            </div>
                    ...
                    <li class="sidebar__item">
                        <a href="index.php?c=Catalogo&a=home" class="sidebar__link">
                            <div class="sidebar__icon">
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M19,19H5V5H19V19M12,17H17V15H14V7H12V17Z" />
                                </svg>
                            </div>
