...
<body>
    ...
    <table id="DiagnosticosDatatable" class="display">
        ...
        <tbody>
            <?php foreach ($diagnosticos as $diagnostico): ?>
                <tr>
                    <td><?= htmlspecialchars($diagnostico['id_diagnostico']) ?></td>
                    <td><?= htmlspecialchars($diagnostico['diag_nombre']) ?></td>
                    <td><?= htmlspecialchars($diagnostico['diag_descripcion']) ?></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#DiagnosticosDatatable').DataTable({
                    dom: "Blfrtip",
