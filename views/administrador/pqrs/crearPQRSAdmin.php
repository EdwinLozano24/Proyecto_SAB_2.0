...
<body>
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/views/.general/layoutsFinal/admin/nav/navPqrs.php');
    ...
    <main class="main-content">
        <div class="pqr-container">
            ...
            <!-- Formulario -->
            <div class="form-card">
                <form action="/controllers/PqrsController.php?accion=store&rol=AdministradorHome" method="POST">
                    <!-- Campos ocultos -->
