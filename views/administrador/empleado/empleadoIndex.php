...
FROM 
    tbl_empleados AS e
INNER JOIN 
    tbl_usuarios AS eu ON e.empl_usuario = eu.id_usuario
INNER JOIN 
    tbl_roles AS er ON e.empl_rol = er.id_rol
 ORDER BY
        CASE empl_estado
            WHEN 'Activo' THEN 1
            ELSE 2
...
<body>
    ...
    <table id="EmpleadosDatatable" class="display">
        <thead>
            <tr>
                <th>ID empleado</th>
  ...
  <tbody>
            <?php foreach ($empleados as $empleado): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($empleado['nombre_del_empleado']) ?></td>
                    <td><?= htmlspecialchars($empleado['numero_de_documento']) ?></td>
                    <td><?= htmlspecialchars($empleado['rol_asignado']) ?></td>
                     <td><?= htmlspecialchars($empleado['empl_fecha_ingreso']) ?></td>
                    <td><?= htmlspecialchars($empleado['empl_descripcion_especifica']) ?></td>
                     <td><?= htmlspecialchars($empleado['empl_estado']) ?></td>
                
                    <td>
                        <a href="/proyecto_sab/controllers/EmpleadoController.php?accion=view_update&id_empleado=<?= $empleado['id_empleado'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a href="/proyecto_sab/controllers/EmpleadoController.php?accion=delete&id_empleado=<?= $empleado['id_empleado'] ?>"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
