...
<body class="catalogo-page">
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/views/.general/layoutsFinal/admin/nav/navTratamiento.php');
    ...
    <div id="tratamientoModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/views/administrador/cita/citaAgendarAdmin.php" class="btn-agendar">Agendar Cita</a>
            </div>
        </div>
    </div>
