...
$(document).ready(function() {
    const table = $('#citaDatatable').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                customize: function(doc) {
                    ...
                    doc.defaultStyle = { fontSize: 10, margin: [10, 10, 10, 10] };
                    doc.content[0].margin = [0, 20, 0, 10];
                    doc.content[0].alignment = 'center';
                    doc.content[0].fontSize = 14;
                    doc.styles.tableHeader = {
                        bold: true, fontSize: 11,
                        color: 'white', fillColor: '#00AEEF',
                        alignment: 'center', margin: [5, 5, 5, 5]
                    };
        ...
        language: {
            ...
            buttons: {
                copy: "Copiar", colvis: "Visibilidad", collection: "Colección",
                colvisRestore: "Restaurar visibilidad", copyKeys: "Presione ctrl o ⌘ + C para copiar.",
                copySuccess: { "1": "Copiada 1 fila", "_": "Copiadas %ds filas" },
                copyTitle: "Copiar al portapapeles", csv: "CSV", excel: "Excel",
                pdf: "PDF", print: "Imprimir",
                pageLength: { "-1": "Mostrar todas", "_": "Mostrar %d filas" }
            },
            thousands: ".", decimal: ",", infoThousands: ".",
            stateRestore: { removeTitle: "Remover Estado", renameTitle: "Cambiar Nombre Estado" }
        }
    });

    // Mueve los botones al div con id="botonesExportacion"
