...
<body>
    <?php 
        ...
        include($_SERVER['DOCUMENT_ROOT'] . '/views/.general/layoutsFinal/paciente/aside/asideTusCitas.php');
    ?>
    <main class="main-content">
            <h2 class="content-title">Tus Citas Pendientes</h2>
            <p class="content-subtitle">Recuerda verificar la fecha de las citas cercanas</p>
        <table id="PacienteCitas" class="table-custom daTatable">
            <thead>
                <tr>
                    <th>Fecha</th>
                    <th>Hora Inicio</th>
            ...
            <tbody>
                <?php foreach ($cita as $cit): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($cit['usua_nombre']) ?></td>
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#PacienteCitas').DataTable({
                    buttons: [],
