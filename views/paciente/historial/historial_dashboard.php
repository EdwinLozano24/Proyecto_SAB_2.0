    ...
    <main class="main-content">
        ...
        <div class="content-grid">
            <div class="content-card">
                ...
                <a href="controllers/HistorialController.php?accion=solicitarHistorial&id_usuario=<?php $id_usuario ?>" class="btn btn-primary" style="margin-top: 16px;">Solicitalo Aqui.</a>
            </div>
        </div>
    </main>
<?php 
