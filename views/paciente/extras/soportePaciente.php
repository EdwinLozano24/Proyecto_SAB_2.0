    ...
    <main class="main-content">
        <div class="soporte-container">
            <section class="soporte-section">
                ...
                <!-- Documentación -->
                <div class="content-card">
                    <h2 class="card-title"><i class="fas fa-folder-open"></i> Documentación</h2>
                    <p class="card-description">Descarga los documentos oficiales de SAB:</p>
                    <ul class="card-description">
                        ...
                        <li>⚙️ <a href="https://drive.google.com/drive/u/0/folders/1MuHPP3ZnmY7lxyoYofJd_OP-3XafH_qv" target="_blank">Manual Técnico</a></li>
