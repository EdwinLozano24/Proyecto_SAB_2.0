...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2025 a las 00:27:32
...
--
-- Estructura de tabla para la tabla `auditoria_sab`
--

CREATE TABLE `auditoria_sab` (
  `Usuario` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Fecha` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `Cambio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `auditoria_sab`
--

INSERT INTO `auditoria_sab` (`Usuario`, `Fecha`, `Cambio`) VALUES
('@', '2024-12-03 15:46:57', 'Se han actualizado los datos exitosamente.'),
('@', '2024-12-03 15:51:39', 'Se han actualizado los datos del empleado bajo el numero de documento: 1009029491 y el nombre: Juan Salazar  exitosamente.'),
('@', '2024-12-03 15:54:09', 'Se han actualizado los datos del empleado bajo el numero de documento: 1009029491 y el nombre: Juan Salazar  exitosamente.'),
('@', '2024-12-03 15:54:16', 'Se han actualizado los datos del empleado bajo el numero de documento: 1009029491 y el nombre: Juan Salazar  exitosamente.'),
('@', '2024-12-03 15:57:13', 'Se han actualizado los datos del empleado bajo el numero de documento: 1009029491 y el nombre: Juan Salazar  exitosamente.'),
('root@localhost', '2024-12-04 22:36:50', 'Se han actualizado los datos de la cita:  2025-01-24, 13:00:00, Asignada al especialista: Fabian Rodriguez'),
('root@localhost', '2024-12-04 23:09:01', 'Se han actualizado los datos exitosamente.'),
('root@localhost', '2024-12-05 12:30:26', 'Se han actualizado los datos exitosamente.'),
('root@localhost', '2025-04-22 15:37:12', 'Se han actualizado los datos exitosamente.'),
('root@localhost', '2025-04-22 19:44:15', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:46:02', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:46:05', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:46:32', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:46:44', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:47:20', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:47:41', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:51:56', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:52:03', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:52:53', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:53:02', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:54:22', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:54:35', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:55:41', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:55:53', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:57:20', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:57:29', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 19:58:23', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 19:58:31', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 20:01:02', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:01:58', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 20:02:27', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:02:31', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 20:02:41', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:02:55', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo+1@gmail.com.'),
('root@localhost', '2025-04-22 20:05:57', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:06:00', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo+1@gmail.com.'),
('root@localhost', '2025-04-22 20:06:54', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:06:57', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo+1@gmail.com.'),
('root@localhost', '2025-04-22 20:07:36', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:07:44', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo+1@gmail.com.'),
('root@localhost', '2025-04-22 20:10:33', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:10:38', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo+1@gmail.com.'),
('root@localhost', '2025-04-22 20:11:19', 'Se a eliminado el registro de paciente Jhon Doeexitosamente.'),
('root@localhost', '2025-04-22 20:11:37', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: santiagocarranzacarrillo@gmail.com.'),
('root@localhost', '2025-04-22 22:07:25', 'Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: krissbp@gmail.com.');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `catalogo_vista_paciente`
--

CREATE TABLE `catalogo_vista_paciente` (
  `cat_nombre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cat_costos` float(8,2) DEFAULT NULL,
  `cat_recomendaciones` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cat_duracion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cat_descripcion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `int_actualizar`
--

CREATE TABLE `int_actualizar` (
  `act_id` int(10) NOT NULL,
  `act_hist_id` int(11) NOT NULL,
  `act_espe_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `int_actualizar`
--

INSERT INTO `int_actualizar` (`act_id`, `act_hist_id`, `act_espe_id`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 2),
(4, 4, 2),
...
--
-- Estructura de tabla para la tabla `int_generar`
--

CREATE TABLE `int_generar` (
  `gen_id` int(10) NOT NULL,
  `gen_paci_num_documento` int(10) DEFAULT NULL,
  `gen_cita_fecha` date DEFAULT NULL,
  `gen_cita_hora` time DEFAULT NULL,
  `gen_cita_especialista` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `int_generar`
--

INSERT INTO `int_generar` (`gen_id`, `gen_paci_num_documento`, `gen_cita_fecha`, `gen_cita_hora`, `gen_cita_especialista`) VALUES
(1, 1019019492, '2024-12-05', '10:00:00', 'Julio Ramiro'),
(2, 1033421135, '2025-03-27', '11:00:00', 'Paola Machado'),
(4, 1032677405, '2025-05-29', '13:00:00', 'Marco Apolo'),
(5, 1070592663, '2025-07-30', '14:00:00', 'Dereck Reus');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `int_gestionar`
--

CREATE TABLE `int_gestionar` (
  `ges_id` int(10) NOT NULL,
  `ges_trat_id` int(11) NOT NULL,
  `ges_espe_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `int_gestionar`
--

INSERT INTO `int_gestionar` (`ges_id`, `ges_trat_id`, `ges_espe_id`) VALUES
(1, 1, 3),
(2, 2, 3),
(3, 3, 3),
(4, 4, 3),
...
--
-- Estructura de tabla para la tabla `int_responder`
--

CREATE TABLE `int_responder` (
  `resp_id` int(10) NOT NULL,
  `resp_pqr_id` int(11) NOT NULL,
  `resp_empl_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `int_responder`
--

INSERT INTO `int_responder` (`resp_id`, `resp_pqr_id`, `resp_empl_id`) VALUES
(1, 1, 3),
(2, 2, 3),
(3, 3, 3),
(4, 4, 3),
...
--
-- Estructura de tabla para la tabla `pacientes_inactivos`
--

CREATE TABLE `pacientes_inactivos` (
  `paci_num_documento` int(10) DEFAULT NULL,
  `paci_nombre` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paci_estado` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `sus_datos_paciente`
--

CREATE TABLE `sus_datos_paciente` (
  `paci_num_documento` int(10) DEFAULT NULL,
  `paci_nombre` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paci_correo_electronico` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paci_contraseña` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `paci_sexo_id` tinyint(4) DEFAULT NULL,
  `paci_rh_id` tinyint(4) DEFAULT NULL,
  `paci_eps_id` int(11) DEFAULT NULL,
  `paci_doc_id` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tbl_documentos` (
  ...
  `Doc_Desc` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_documentos` (`Doc_Id`, `Doc_Desc`) VALUES
(1, 'Tarjeta Identidad'),
(2, 'Cedula Ciudadania '),
...
CREATE TABLE `tbl_pacientes` (
  ...
  `paci_contraseña` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `paci_num_contacto` bigint(20) DEFAULT NULL,
  `paci_direccion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paci_fecha_nacimiento` date DEFAULT NULL,
  `paci_num_acudiente` bigint(20) DEFAULT NULL,
...
INSERT INTO `tbl_pacientes` (`paci_num_documento`, `paci_nombre`, `paci_correo_electronico`, `paci_contraseña`, `paci_num_contacto`, `paci_direccion`, `paci_fecha_nacimiento`, `paci_num_acudiente`, `paci_estado`, `paci_sexo_id`, `paci_rh_id`, `paci_eps_id`, `paci_doc_id`) VALUES
(1019019492, 'Juan Esteban Castro Escamilla', 'juanestebanacstroescamilla171@gmail.com', 'pika232', 3000000001, 'Carrera 132c 29 09', '2005-09-28', 3000000002, 'Activo', 1, 2, 2, 2),
(1032677405, 'Edwin Camilo Chaparro', 'chaparro23@hotmail.com', 'Galek2', 3000000066, 'Carrera 9a 09', '2004-12-04', 3000000022, 'Activo', 1, 3, 1, 2),
(1033421135, 'Agnel Jose Tinoco', 'tinocosalazar20@gmail.com', '23231', 3000000009, 'Av 9 cr 2', '2005-10-24', 3000000004, 'Inactivo', 1, 2, 2, 2),
(1070592663, 'Santigoa Carranza Carillo', 'carranza2kk@hotmail.com', 'Maty1709', 3209295978, 'Avenida 7 con calle 20', '2005-11-20', 3000000045, 'Inactivo', 1, 2, 3, 2),
(1070592665, 'Jhon Doe', 'santiagocarranzacarrillo@gmail.com', '1234', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(1070592666, 'Pepe Pecas Pica Papas', 'krissbp@gmail.com', '12345', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(1140915008, 'Angelo Daniel Madero', 'maderin2004@gmail.com', 'juilo23', 3000000006, 'Avenida llano', '2006-07-07', 3000000008, 'Inactivo', 1, 1, 1, 2);

--
-- Disparadores `tbl_pacientes`
--
DELIMITER $$
CREATE TRIGGER `Dis_Actualizacion_Paciente` AFTER UPDATE ON `tbl_pacientes` FOR EACH ROW INSERT into Auditoria_sab (usuario,fecha,cambio) VALUES (CURRENT_USER, CURRENT_TIMESTAMP, "Se han actualizado los datos exitosamente.")
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Dis_Borrar_Paciente` AFTER DELETE ON `tbl_pacientes` FOR EACH ROW INSERT INTO Auditoria_sab (usuario,fecha,cambio) VALUES (CURRENT_USER(),CURRENT_TIMESTAMP,CONCAT("Se a eliminado el registro de paciente ",old.paci_nombre, "exitosamente."))
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Dis_Registro_Paciente` AFTER INSERT ON `tbl_pacientes` FOR EACH ROW INSERT INTO Auditoria_sab (usuario,fecha,cambio) VALUES (CURRENT_USER(),CURRENT_TIMESTAMP,CONCAT("Se a registrado un nuevo paciente exitosamente, se notificara al correo electronico: ",new.paci_correo_electronico,"."))
$$
DELIMITER ;
...
--
-- Estructura de tabla para la tabla `tbl_rhs`
--

CREATE TABLE `tbl_rhs` (
  `Rh_Id` tinyint(2) NOT NULL,
  `Rh_Desc` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `tbl_rhs`
--

INSERT INTO `tbl_rhs` (`Rh_Id`, `Rh_Desc`) VALUES
(2, 'A+'),
(3, 'A-'),
(6, 'AB+'),
(7, 'AB- '),
...
CREATE TABLE `tbl_roles` (
  ...
  `rol_nombre` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `rol_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_roles` (`rol_id`, `rol_nombre`, `rol_desc`) VALUES
(1, 'Administrador', 'Encargado General '),
(2, 'Asistente Tecnico', 'Reparaciones de Informatica'),
(3, 'Encargado PQR\'s', 'Encargado de las solicitudes PQR'),
(4, 'Recepcionista', 'Organizacion y Gestion de documentos'),
(5, 'Publicista', 'Promocionar a traves de redes sociales');
...
CREATE TABLE `tbl_sexos` (
  ...
  `Sexo_Desc` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_sexos` (`Sexo_Id`, `Sexo_Desc`) VALUES
(1, 'Masculino'),
(2, 'Femenino');
...
--
-- Indices de la tabla `int_actualizar`
--
ALTER TABLE `int_actualizar`
  ADD PRIMARY KEY (`act_id`),
  ADD KEY `act_hist_id` (`act_hist_id`),
  ADD KEY `act_espe_id` (`act_espe_id`);

--
-- Indices de la tabla `int_generar`
--
ALTER TABLE `int_generar`
  ADD PRIMARY KEY (`gen_id`),
  ADD KEY `gen_cita_fecha` (`gen_cita_fecha`),
  ADD KEY `gen_cita_hora` (`gen_cita_hora`),
  ADD KEY `gen_cita_especialista` (`gen_cita_especialista`),
  ADD KEY `gen_paci_num_documento` (`gen_paci_num_documento`),
  ADD KEY `int_generar_ibfk_1` (`gen_cita_fecha`,`gen_cita_hora`,`gen_cita_especialista`);

--
-- Indices de la tabla `int_gestionar`
--
ALTER TABLE `int_gestionar`
  ADD PRIMARY KEY (`ges_id`),
  ADD KEY `ges_trat_id` (`ges_trat_id`),
  ADD KEY `ges_espe_id` (`ges_espe_id`);

--
-- Indices de la tabla `int_responder`
--
ALTER TABLE `int_responder`
  ADD PRIMARY KEY (`resp_id`),
  ADD KEY `resp_pqr_id` (`resp_pqr_id`),
  ADD KEY `resp_empl_id` (`resp_empl_id`);
...
ALTER TABLE `tbl_pacientes`
  ...
  ADD KEY `paci_sexo_id` (`paci_sexo_id`),
  ADD KEY `paci_rh_id` (`paci_rh_id`),
  ADD KEY `paci_eps_id` (`paci_eps_id`),
  ADD KEY `paci_doc_id` (`paci_doc_id`);
...
--
-- Indices de la tabla `tbl_rhs`
--
ALTER TABLE `tbl_rhs`
  ADD PRIMARY KEY (`Rh_Id`),
  ADD UNIQUE KEY `Rh_Desc` (`Rh_Desc`);
...
--
-- AUTO_INCREMENT de la tabla `int_actualizar`
--
ALTER TABLE `int_actualizar`
  MODIFY `act_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `int_generar`
--
ALTER TABLE `int_generar`
  MODIFY `gen_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `int_gestionar`
--
ALTER TABLE `int_gestionar`
  MODIFY `ges_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `int_responder`
--
ALTER TABLE `int_responder`
  MODIFY `resp_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Filtros para la tabla `int_actualizar`
--
ALTER TABLE `int_actualizar`
  ADD CONSTRAINT `int_actualizar_ibfk_1` FOREIGN KEY (`act_hist_id`) REFERENCES `tbl_historia_clinica` (`hist_id`),
  ADD CONSTRAINT `int_actualizar_ibfk_2` FOREIGN KEY (`act_espe_id`) REFERENCES `tbl_especialistas` (`espe_id`);

--
-- Filtros para la tabla `int_generar`
--
ALTER TABLE `int_generar`
  ADD CONSTRAINT `int_generar_ibfk_1` FOREIGN KEY (`gen_cita_fecha`,`gen_cita_hora`,`gen_cita_especialista`) REFERENCES `tbl_citas` (`cit_fecha`, `cit_hora`, `cit_especialista`),
  ADD CONSTRAINT `int_generar_ibfk_2` FOREIGN KEY (`gen_paci_num_documento`) REFERENCES `tbl_pacientes` (`paci_num_documento`);

--
-- Filtros para la tabla `int_gestionar`
--
ALTER TABLE `int_gestionar`
  ADD CONSTRAINT `int_gestionar_ibfk_1` FOREIGN KEY (`ges_trat_id`) REFERENCES `tbl_tratamientos` (`trat_id`),
  ADD CONSTRAINT `int_gestionar_ibfk_2` FOREIGN KEY (`ges_espe_id`) REFERENCES `tbl_especialistas` (`espe_id`);

--
-- Filtros para la tabla `int_responder`
--
ALTER TABLE `int_responder`
  ADD CONSTRAINT `int_responder_ibfk_1` FOREIGN KEY (`resp_pqr_id`) REFERENCES `tbl_pqrs` (`pqr_id`),
  ADD CONSTRAINT `int_responder_ibfk_2` FOREIGN KEY (`resp_empl_id`) REFERENCES `tbl_empleados` (`empl_id`);
...
--
ALTER TABLE `tbl_empleados`
  ADD CONSTRAINT `tbl_empleados_ibfk_1` FOREIGN KEY (`empl_sexo_id`) REFERENCES `tbl_sexos` (`Sexo_Id`),
  ADD CONSTRAINT `tbl_empleados_ibfk_2` FOREIGN KEY (`empl_rh_id`) REFERENCES `tbl_rhs` (`Rh_Id`),
  ADD CONSTRAINT `tbl_empleados_ibfk_3` FOREIGN KEY (`empl_eps_id`) REFERENCES `tbl_eps` (`Eps_Id`),
  ADD CONSTRAINT `tbl_empleados_ibfk_4` FOREIGN KEY (`empl_doc_id`) REFERENCES `tbl_documentos` (`Doc_Id`),
  ADD CONSTRAINT `tbl_empleados_ibfk_5` FOREIGN KEY (`empl_rol_id`) REFERENCES `tbl_roles` (`rol_id`);
...
--
ALTER TABLE `tbl_historia_clinica`
  ADD CONSTRAINT `tbl_historia_clinica_ibfk_1` FOREIGN KEY (`hist_paci_num_documento`) REFERENCES `tbl_pacientes` (`paci_num_documento`);

--
-- Filtros para la tabla `tbl_pacientes`
--
ALTER TABLE `tbl_pacientes`
  ADD CONSTRAINT `tbl_pacientes_ibfk_1` FOREIGN KEY (`paci_sexo_id`) REFERENCES `tbl_sexos` (`Sexo_Id`),
  ADD CONSTRAINT `tbl_pacientes_ibfk_2` FOREIGN KEY (`paci_rh_id`) REFERENCES `tbl_rhs` (`Rh_Id`),
  ADD CONSTRAINT `tbl_pacientes_ibfk_3` FOREIGN KEY (`paci_eps_id`) REFERENCES `tbl_eps` (`Eps_Id`),
  ADD CONSTRAINT `tbl_pacientes_ibfk_4` FOREIGN KEY (`paci_doc_id`) REFERENCES `tbl_documentos` (`Doc_Id`);

--
-- Filtros para la tabla `tbl_pqrs`
--
ALTER TABLE `tbl_pqrs`
  ADD CONSTRAINT `tbl_pqrs_ibfk_1` FOREIGN KEY (`pqr_paci_num_documento`) REFERENCES `tbl_pacientes` (`paci_num_documento`);

--
-- Filtros para la tabla `tbl_tratamientos`
--
ALTER TABLE `tbl_tratamientos`
  ADD CONSTRAINT `tbl_tratamientos_ibfk_1` FOREIGN KEY (`trat_paci_num_documento`) REFERENCES `tbl_pacientes` (`paci_num_documento`);
COMMIT;
