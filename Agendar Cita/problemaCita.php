...
<head>
    ...
    <link rel="stylesheet" href="../Agendar Cita/Estilos/style3.css">
...
<body>
    <nav>
        <!-- Esta es la pagina a la cual se le redirecciona al paciente si tiene problemas para agendarla -->
        <img id="nav--logo-imagen" src="../Logo/logo.jpg" alt="Imagen del logo de SAB">
        <h1>Salud Benefit</h1>
    ...
    <div id="problemas--cita">
    <form action="problemas.php" method="POST" id="formProblema">
        <h2>Cuéntenos su problema</h2>
        <div class="textarea">
            <textarea name="descripcion" id="descripcion" minlength="10" maxlength= "1000" required></textarea>
...
<script src= "/Agendar Cita/Agendar Cita/Validacion/validacion2.js"></script>
